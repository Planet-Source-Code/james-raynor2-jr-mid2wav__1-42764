...
Begin VB.Form frmConvert2 
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      Caption         =   "Conversione WAV ==> MP3 in corso.."
      Height          =   228
      Left            =   96
      TabIndex        =   1
      Top             =   96
...
Private Sub Form_Load()
  Text1.text = frmBatch.txtSalva.text
...
Timer1.Enabled = False
  ...
  frmBatch.Enabled = True
  frmBatch.Frame1.Enabled = True
  frmBatch.Frame2.Enabled = True
  frmBatch.Command3.Enabled = True
  frmBatch.Command3.Caption = "CONVERTI"
  Unload Me
